Vagrant.configure("2") do |config|
  ...
  config.vm.define "kindmaster" do |node|
    ...
    node.vm.provision "setup-iptables", type: "shell", :path => "ubuntu/ingress/iptables.sh"
  end
